...
import { unref, withCtx, createTextVNode, useSSRContext } from 'file://C:/Users/varga/OneDrive/Documents/GitHub/tiendadeportiva.vue/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate } from 'file://C:/Users/varga/OneDrive/Documents/GitHub/tiendadeportiva.vue/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref($carrito).length === 0) {
        _push(`<div class="text-center py-8"><p class="text-xl text-gray-600">Tu carrito est\xE1 vac\xEDo</p>`);
...
//# sourceMappingURL=carrito-Drjjzm9X.mjs.map
